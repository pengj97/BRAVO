...
class OursWorker(Softmax):
    ...
    def loopless_lsvrg(self, image, label):
        # 0时刻求全梯度
    ...
    def train(self, image, label):
        ...
        :return:
        """
        partical_gradient = self.loopless_lsvrg(image, label)  # loopless svrg
...
def ours(setting, attack, flag_time_varying):
    ...
    conf = Config.DrsaSVRGConfig.copy()
    ...
    output = open("../../experiment-results/drsa-lsvrg"+last_str+".pkl", "wb")
