...
def draw_byz_frac_2(attack):
    methods = ['dpsgd', 'byrdie', 'bridge', 'december', 'december-saga',  'december-lsvrg']
    labels = ['DPSGD', 'ByRDiE-S', 'BRIDGE-S', 'DRSA', 'BRAVO-SAGA',  'BRAVO-LSVRG']
    ...
    plt.savefig('pdf/byz-frac-2.pdf', bbox_inches='tight')
    plt.show()


if __name__ == '__main__':
    draw_byz_frac_2(attack='sd')
